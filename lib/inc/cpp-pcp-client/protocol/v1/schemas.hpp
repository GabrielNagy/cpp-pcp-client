...
CPP_PCP_CLIENT_EXPORT Schema EnvelopeSchema();
...
CPP_PCP_CLIENT_EXPORT Schema AssociateResponseSchema();
...
CPP_PCP_CLIENT_EXPORT Schema DebugSchema();
...
CPP_PCP_CLIENT_EXPORT Schema DebugItemSchema();
